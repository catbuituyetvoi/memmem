	        	...
	        	if( Object::find($objectId)->language == "jp")
	        	 {
	        	 	...
	        	 	$add = WordJP::create(
								array(
									...
									'kanjiMean' => Input::get('kanjiMean'),
									'englishMean' => strtolower( Input::get('englishMean') ),
									'hiragana' => Input::get('hiragana'),
									'synonyms' => Input::get('synonyms'),
									'romaji' => strtolower( Input::get('romaji') ),
									'definition' => Input::get('definition'),
									'definitionVi' => Input::get('definitionVi'),
									'exampleJp' => Input::get('exampleJp'),
									'exampleEn' => Input::get('exampleEn'),
									'exampleVi' => Input::get('exampleVi'),
									'attributes' => Input::get('attributes'),
									'similar' => Input::get('similar'),
